...
################################################################################
# SkyrakSys HRM - Complete Cleanup & Docker Deployment Script
# 
...
#
# This script will:
#   1. Clean existing PM2/Node.js deployment
#   2. Install Docker & Docker Compose
#   3. Deploy fresh with Docker
#   4. Setup SSL with Let's Encrypt
#   5. Configure firewall
#
# Usage: bash cleanup-and-deploy-docker.sh
################################################################################
