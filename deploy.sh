...
################################################################################
# SkyrakSys HRM - One-Click Deployment Script
# 
# Description: Automated deployment to production server with Docker
# Server: skyait.skyraksys.com (46.225.73.94)
# OS: Ubuntu 24.04.3 LTS
#
# Usage: ./deploy.sh [options]
#   Options:
#     --clean         Clean existing deployment before deploying
