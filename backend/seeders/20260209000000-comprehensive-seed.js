  ...
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      await queryInterface.bulkInsert('employees', [
        { id: empIds.admin, employeeId: 'SK001', firstName: 'System', lastName: 'Administrator', email: 'admin@skyraksys.com', phone: '9876543210', hireDate: '2024-01-01', status: 'Active', departmentId: deptIds.hr, positionId: posIds.hrManager, userId: userIds.admin, nationality: 'Indian', employmentType: 'Full-time', probationPeriod: 0, noticePeriod: 90, createdAt: now, updatedAt: now },
        { id: empIds.hrManager, employeeId: 'SK002', firstName: 'Sarah', lastName: 'Johnson', email: 'hr@skyraksys.com', phone: '9876543211', hireDate: '2024-01-15', status: 'Active', departmentId: deptIds.hr, positionId: posIds.hrManager, userId: userIds.hrManager, nationality: 'Indian', employmentType: 'Full-time', probationPeriod: 6, noticePeriod: 60, createdAt: now, updatedAt: now },
        { id: empIds.teamLead, employeeId: 'SK003', firstName: 'John', lastName: 'Smith', email: 'lead@skyraksys.com', phone: '9876543212', hireDate: '2024-02-01', status: 'Active', departmentId: deptIds.engineering, positionId: posIds.teamLead, userId: userIds.teamLead, nationality: 'Indian', employmentType: 'Full-time', probationPeriod: 6, noticePeriod: 60, createdAt: now, updatedAt: now },
        { id: empIds.employee1, employeeId: 'SK004', firstName: 'Alice', lastName: 'Brown', email: 'employee1@skyraksys.com', phone: '9876543213', hireDate: '2024-03-01', status: 'Active', departmentId: deptIds.engineering, positionId: posIds.softwareEngineer, managerId: empIds.teamLead, userId: userIds.employee1, nationality: 'Indian', employmentType: 'Full-time', probationPeriod: 6, noticePeriod: 30, createdAt: now, updatedAt: now },
        { id: empIds.employee2, employeeId: 'SK005', firstName: 'Bob', lastName: 'Wilson', email: 'employee2@skyraksys.com', phone: '9876543214', hireDate: '2024-03-15', status: 'Active', departmentId: deptIds.engineering, positionId: posIds.softwareEngineer, managerId: empIds.teamLead, userId: userIds.employee2, nationality: 'Indian', employmentType: 'Full-time', probationPeriod: 6, noticePeriod: 30, createdAt: now, updatedAt: now }
      ]);
